...
System integration belongs in `AwakeCore`, never in the view. Disable sleep must read and write `pmset -a disablesleep 1|0` (admin via osascript). IOKit assertions are extra while the flag is on.
